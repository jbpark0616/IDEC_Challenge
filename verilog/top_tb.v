...
initial begin
  $readmemh("C:/IDEC_challenge/data/2_0.txt", pixels);
  clk <= 1'b0;
  rst_n <= 1'b1;
  #3
  rst_n <= 1'b0;
...
initial begin
   //conv1
   $readmemh("C:/IDEC_challenge/data/conv1_weight_1.txt", weight_11);
   $readmemh("C:/IDEC_challenge/data/conv1_weight_2.txt", weight_12);
   $readmemh("C:/IDEC_challenge/data/conv1_weight_3.txt", weight_13);
   $readmemh("C:/IDEC_challenge/data/conv1_bias.txt", bias_1);
   //conv2
   $readmemh("C:/IDEC_challenge/data/conv2_bias.txt", bias_2);
   	$readmemh("C:/IDEC_challenge/data/conv2_weight_11.txt", weight_211);
	$readmemh("C:/IDEC_challenge/data/conv2_weight_12.txt", weight_212);
	$readmemh("C:/IDEC_challenge/data/conv2_weight_13.txt", weight_213);
	$readmemh("C:/IDEC_challenge/data/conv2_weight_21.txt", weight_221);
	$readmemh("C:/IDEC_challenge/data/conv2_weight_22.txt", weight_222);
	$readmemh("C:/IDEC_challenge/data/conv2_weight_23.txt", weight_223);
    $readmemh("C:/IDEC_challenge/data/conv2_weight_31.txt", weight_231);
	$readmemh("C:/IDEC_challenge/data/conv2_weight_32.txt", weight_232);
	$readmemh("C:/IDEC_challenge/data/conv2_weight_33.txt", weight_233);
   //fullyconnected
   $readmemh("C:/IDEC_challenge/data/fc_weight.txt", weight_fc);
   $readmemh("C:/IDEC_challenge/data/fc_bias.txt", bias_fc);
 end
...
// Read image text file
initial begin
  $readmemh("C:/IDEC_challenge/data/input_1000.txt", pixels);
  cnt <= 0;
  img_idx <= 0;
  clk <= 1'b0;
  input_cnt <= -1;
